...
<div id="wrapper">
  <header id="header">
	<div id="moto">
		<div class="r"><a href="admin/index.html">AdminLogIn</a></div>
  ...
  <nav id="nav">
	...
	<div id="socialnav">
		<a href="admin/register.html"><span class="spp"><strong>Register</strong></span></a>
		<a href="user_login/index.html"><span class="spp"><strong>Log In</strong></span></a>
  ...
  <div id="main">
	...
	<aside id="sidebar">
	  <?php        
		$q = mysqli_query($conn, "select news.id_news, news.headline, news.content from news join categories on 
		news.id_category = categories.id_category join images on news.id_image = images.id_image ORDER BY date DESC");
		while($rw=mysqli_fetch_object($q)) {
		?>
			<div class="side">
				<h4><?php echo $rw->headline; ?></h4>
				<p class="content_side"><?php echo nl2br($rw->content); ?></p>
			</div>
  ...
  <footer id="footer">
    <nav>
		...
		<a href="?page=4">NHL</a>|
		<a href="?page=5">MLS</a>|
		<a href="admin/index.html"><span>AdminLogIn</span></a>
	</nav>
	<hr>
	<div id="social">
		<a href="https://www.facebook.com/"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
